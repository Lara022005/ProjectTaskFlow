...
public class AgendamentoDAO {
	...
	public void create(Agendamento agendamento) {
		...
		try {
			...
			stmt.setString(3, agendamento.getIdCliente());
			stmt.setString(4, agendamento.getDataAgendamento());
			stmt.setString(5, agendamento.getDescricao());
	...
	public void update(Agendamento agendamento) {
		...
		try {
			...
			stmt = con.prepareStatement("");	// ------------------------ FALTA	
			stmt.setString(1, agendamento.getId());
			stmt.setString(2, agendamento.getIdServico());
